<template>
    <Card ref="cards" v-for="index in fieldSize * fieldSize" :key="index" @select="onSelect"></Card>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            generate() {
                ...
                for (let i = 0; i < this.fieldSize * this.fieldSize / colorNames.length; i++)
                    array.push(...colorNames);

                array.length = this.fieldSize * this.fieldSize;
                ...
                let gridSize = Array(this.fieldSize).fill('1fr');
